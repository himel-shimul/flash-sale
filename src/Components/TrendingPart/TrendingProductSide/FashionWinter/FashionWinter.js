...
const FashionWinter = () => {
    ...
    return (
        ...
        <h2 className="text-2xl my-7">
          <strong>Fashion</strong> For Winter
        </h2>
        <div className="flex items-center my-2 mr-2">
          ...
          <BsFillArrowRightCircleFill className="text-2xl"></BsFillArrowRightCircleFill>
            ...
            <button className="text-center mt-3 text-white bg-black py-3 rounded w-full bg-[#cfe4d8]">View All </button>
        </div>
    );
};

export default FashionWinter;